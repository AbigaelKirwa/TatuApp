            ...
            <div class="item1"><p id="rcorners1"><br>ADMIN<br><br>
                ...
                <div class="item6"><table id="rcorners6" class="table">
                    ...
                    <?php
                        ...
                        {
                            $query = "SELECT *FROM `users`LIMIT " . $initial_page . ',' . $limit;  
                            ...
                            while($row = mysqli_fetch_array($result)){
                               ...
                               <tr>
                                   ...
                                   <td>
                                        <button type="button" class="btn btn-warning" id="editbtn"><a name="update_user" href="update_user.php?id=<?php echo $row['user_id']; ?>">Update</a></button>
                                        <button type="button" class="btn btn-danger"id ="deletebtn"><a name="queries/delete_user" href="queries/delete_user.php?id=<?php echo $row['user_id']; ?>">Delete</a></button>
                                    </td>
                               </tr>
                               <?php
                            }
                ...
                <?php
                    for($page_number = 1; $page_number<= $total_pages; $page_number++) {  
                        ...
                        echo '<a class="pagination" href = "admin_user.php?page=' . $page_number . '">' . $page_number . ' </a>';  
                
                    }  
                ?>
            <button type="button" class="btn btn-success" id ="insertbtn"><a name="insert_user" href="insert_user.php?id=<?php echo $row['id']; ?>">Insert User</a></button>
            </div>
