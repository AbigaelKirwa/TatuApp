            ...
            <div class="item1"><p id="rcorners1"><br>ADMIN<br><br>
                ...
                <div class="item6"><table id="rcorners6" class="table">
                    ...
                    <?php
                        ...
                        {
                            $query = "SELECT *FROM `stage`LIMIT " . $initial_page . ',' . $limit;  
                            ...
                            while($row = mysqli_fetch_array($result)){
                               ...
                               <tr>
                                   ...
                                   <td><?php echo $row['stage_number']; ?></td>
                                   <td><?php echo $row['route_id']; ?></td>
                                   <td><?php echo $row['route_name']; ?></td>
                                   <td>
                                    <button type="button" class="btn btn-warning" id="editbtn"><a name="update_stage" href="update_stage.php?id=<?php echo $row['stage_id']; ?>">Update</a></button>
                                    <button type="button" class="btn btn-danger"id ="deletebtn"><a name="delete_stage" href="queries/delete_stage.php?id=<?php echo $row['stage_id']; ?>">Delete</a></button>
                                    </td>
                               </tr>
                               <?php
                            }
                ...
                <?php
                    for($page_number = 1; $page_number<= $total_pages; $page_number++) {  
                        ...
                        echo '<a class="pagination" href = "admin.php?page=' . $page_number . '">' . $page_number . ' </a>';  
                
                    }  
                ?>
                <button type="button" class="btn btn-success" id ="insertbtn"><a name="insert_stage" href="insert_stage.php?id=<?php echo $row['id']; ?>">Insert Stage</a></button>
            </div>
