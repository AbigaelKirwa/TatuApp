            ...
            <div class="item1"><p id="rcorners1"><br>ADMIN<br><br>
                ...
                <div class="item6"><table id="rcorners6" class="table">
                    ...
                    <?php
                        ...
                        {
                            $query = "SELECT *FROM `fare`LIMIT " . $initial_page . ',' . $limit;  
                ...
                <?php
                    for($page_number = 1; $page_number<= $total_pages; $page_number++) {  
                        ...
                        echo '<a class="pagination" href = "admin_fare.php?page=' . $page_number . '">' . $page_number . ' </a>';  
                
                    }  
                ?>
             <button type="button" class="btn btn-success" id ="insertbtn"><a name="insert_fare" href="insert_fare.php?id=<?php echo $row['id']; ?>">Insert Fare</a></button>
            </div>
